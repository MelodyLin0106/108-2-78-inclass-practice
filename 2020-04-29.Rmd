...
pick_allowanceOver1000 <- example$allowance >= "1001-2000" # 結果會出現無意義，要先執行`ordered`
...
###### 或在設定為factor時即把**levels**排好，並**ordered=T**:
```{r}
example$allowance <-
  factor(
    example$allowance,
...
sum(list_victimAges_female$`數目`) # 結果會是NA，因為資料有NA，所以無法加總
